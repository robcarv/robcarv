...
├── TrueNAS Scale · NVMe Storage (10.9TB)
...
🔒 BACKUP & SECURITY
├── ClamAV (daily scan, 0 threats found)
├── Duplicati + Rsync → TrueNAS
├── Automated Git push (GitHub)
└── UptimeKuma (55+ checks, alert on failure)
```
...
<div align="center">
  ...
  <br>
  <em>3 Pis · 55+ services · 10.9TB NVMe · 0 threats found</em>
</div>
